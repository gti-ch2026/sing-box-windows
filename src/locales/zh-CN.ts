export default {
  ...
  home: {
    ...
    statusDescriptions: {
      runningDesc: '已开启。浏览器走系统代理；Telegram 等 App 可在下方打开「全局接管」',
    ...
    proxyMode: {
      ...
      tun: '全局接管（高级）',
      manual: '手动模式',
      systemTip: '浏览器和多数软件立刻能用，不用电脑密码',
      tunTip: 'Telegram 等所有 App 都走代理，需要输入一次电脑密码；下次打开不会自动开',
      manualTip: '需要手动配置系统代理',
    },
    nodeMode: {
      global: '全局模式',
      rule: '规则模式',
      globalTip: '所有网站都走代理，国内站也会绕一圈，通常更慢',
      ruleTip: '国内直连、国外走代理。日常就用这个',
    },
    quick: {
      testAll: '一键测速',
      nodeMode: '节点模式',
    ...
    sudoPassword: {
      title: '需要系统密码',
      description:
        '全局接管会改电脑默认网络，Telegram 也会走。只在你手动打开时要一次系统密码，保存在本机，不会上传，下次启动也不会自动再开。',
      placeholder: '请输入系统密码',
      save: '保存并继续',
      saved: '系统密码已保存',
